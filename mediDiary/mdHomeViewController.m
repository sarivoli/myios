...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSDateComponents* ageComponents = [[NSCalendar currentCalendar]
                                       ...
                                       fromDate:[dateFormatter dateFromString: [[curProfileList objectAtIndex:indexPath.row] objectForKey:@"dob"]]
                                       toDate:now
                                       options:0];
    ...
    [[cell textLabel] setText:[NSString stringWithFormat:@"%@ (%ld)",[[curProfileList objectAtIndex:indexPath.row] objectForKey:@"name"],(long)age]];
    ...
    if([[[curProfileList objectAtIndex:indexPath.row] objectForKey:@"gender"] isEqualToString:@"Male"]){
            [[cell imageView]setImage:[UIImage imageNamed:@"UserMaleCircle.png"]];
    }else{
            [[cell imageView]setImage:[UIImage imageNamed:@"UserFemaleCircle.png"]];
    }
