...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //matchViewController *matchView = [[matchViewController alloc] initWithNibName:@"matchViewController" bundle:nil];
    // UITabBarController *appTabs = [[UITabBarController alloc]init];

    //UINavigationController *myNav=[[UINavigationController alloc]initWithRootViewController:matchView];
    //[appTabs addChildViewController:myNav];
    //self.window.rootViewController = appTabs;
